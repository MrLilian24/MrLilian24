...
### 💻 Full-Stack Developer | 🤖 ML/AI Dev
...
const rémi = {
    ...
    role: "Full-Stack & AI Developer @ IMAAAGERY",
    education: "BUT Informatique (3rd year)",
    focus: ["Web/Mobile Development", "AI/ML", "DevOps"],
    hobbies: ["🎮 Gaming", "🧁 Baking", "🏋️ Gym"]
};
```
